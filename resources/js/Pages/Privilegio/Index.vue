...
<template>
<AppLayout title="Gestión de Privilegios">
                            ...
                            <table class="table table-sm table-striped mb-0">
                                ...
                                <tbody>
                                    <tr v-for="p in rol.privilegiosAgrupados" :key="p.id">
                                        ...
                                        <td><i :class="p.agregar ? 'fa fa-check text-success' : 'fa fa-times text-danger'"></i></td>
                                        <td><i :class="p.borrar ? 'fa fa-check text-success' : 'fa fa-times text-danger'"></i></td>
                                        <td><i :class="p.modificar ? 'fa fa-check text-success' : 'fa fa-times text-danger'"></i></td>
                                        <td><i :class="p.leer ? 'fa fa-check text-success' : 'fa fa-times text-danger'"></i></td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
                        <td>
                            <a v-if="canEdit" href="#" @click.prevent="showEdit = JSON.parse(JSON.stringify(rol))">
