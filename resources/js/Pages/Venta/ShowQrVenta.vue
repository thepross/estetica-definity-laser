...
const startPolling = () => {
    ...
    pollInterval = setInterval(() => {
        ...
        router.reload({
            ...
            preserveState: true,
            onSuccess: (page) => {
                const updatedVenta = page.props.venta;
                if (ventaActual.value.estado === 'pagado') {
                    stopPolling();
                    return;
                }
                ventaActual.value = updatedVenta;

                console.log('Estado actualizado de la venta:', updatedVenta.estado);
                if (updatedVenta.estado === 'pagado') {
                                ...
                                <div v-else>
                                    ...
                                    <div class="border-top pt-3">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            ...
                                            <span class="h4 fw-bold text-dark m-0">{{ formatoMoneda(ventaActual.total)
                                                }}</span>
                                        </div>
