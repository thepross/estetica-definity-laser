                ...
                <table class="table table-hover" id="ventas">
                    ...
                    <tbody>
                        <tr v-for="venta in ventas" :key="venta.id">
                            ...
                            <td>{{ venta.estado }}</td>
                            <td class="">
                                <button class="btn btn-primary btn-sm" href="#" @click.prevent="verDetalles = venta">Ver
                                    Detalles
                                </button>
                                <button class="btn btn-success btn-sm" href="#" :disabled="venta.estado === 'pagado'"
                                ...
                                <button class="btn btn-danger btn-sm" href="#" @click.prevent="ventaToDelete = venta"><i
                                        class="fa fa-trash"></i>
                                </button>
                            </td>
                        </tr>
